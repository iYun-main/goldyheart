...
import net.iyun.goldyheart.world.tree.*;
...
public static final Block CHILLI_CROP = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "chilli_crop"),
        new ChilliCropBlock(FabricBlockSettings.copyOf(Blocks.WHEAT)));

public static final Block COFFEE_CROP = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "coffee_crop"),
        new CoffeeCropBlock(FabricBlockSettings.copyOf(Blocks.POTATOES)));

public static final Block CORN_CROP = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "corn_crop"),
        new CornCropBlock(FabricBlockSettings.copyOf(Blocks.WHEAT)));

public static final Block CUCUMBER_CROP = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "cucumber_crop"),
        new CucumberCropBlock(FabricBlockSettings.copyOf(Blocks.WHEAT)));

public static final Block GRAPE_CROP = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "grape_crop"),
        new GrapeCropBlock(FabricBlockSettings.copyOf(Blocks.WHEAT)));

public static final Block LETTUCE_CROP = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "lettuce_crop"),
        new LettuceCropBlock(FabricBlockSettings.copyOf(Blocks.WHEAT)));

public static final Block PARSLEY_CROP = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "parsley_crop"),
        new ParsleyCropBlock(FabricBlockSettings.copyOf(Blocks.WHEAT)));

public static final Block ONION_CROP = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "onion_crop"),
        new OnionCropBlock(FabricBlockSettings.copyOf(Blocks.POTATOES)));

public static final Block RICE_CROP = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "rice_crop"),
        new RiceCropBlock(FabricBlockSettings.copyOf(Blocks.POTATOES)));

public static final Block GARLIC_CROP = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "garlic_crop"),
        new GarlicCropBlock(FabricBlockSettings.copyOf(Blocks.POTATOES)));

public static final Block BELLPEPPER_CROP = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "bellpepper_crop"),
        new BellCropBlock(FabricBlockSettings.copyOf(Blocks.WHEAT)));


//Blocks Texture Render Workaround
public static final Block GLASS_TRAPDOOR = registerBlock("glass_trapdoor",
        new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.GLASS), BlockSetType.POLISHED_BLACKSTONE));
...
public static final Block MANGROVE_WOOD_SLAB = registerBlock("mangrove_slab",
        new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.MANGROVE_WOOD_ALLSIDE).sounds(BlockSoundGroup.WOOD)));

public static final Block MANGROVE_WOOD_SLAB_S = registerBlock("mangrove_slab_s",
        new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.MANGROVE_WOOD_ALLSIDE_S).sounds(BlockSoundGroup.WOOD)));
...
public static final Block ACA_WOOD_SLAB = registerBlock("acacia_slab",
        new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.ACA_WOOD_ALLSIDE).sounds(BlockSoundGroup.WOOD)));

public static final Block ACA_WOOD_SLAB_S = registerBlock("acacia_slab_s",
        new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.ACA_WOOD_ALLSIDE_S).sounds(BlockSoundGroup.WOOD)));
...
public static final Block SPRUCE_WOOD_SLAB = registerBlock("spruce_slab",
        new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.SPRUCE_WOOD_ALLSIDE).sounds(BlockSoundGroup.WOOD)));

public static final Block SPRUCE_WOOD_SLAB_S = registerBlock("spruce_slab_s",
         new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.SPRUCE_WOOD_ALLSIDE_S).sounds(BlockSoundGroup.WOOD)));
...
public static final Block JUNGLE_WOOD_SLAB = registerBlock("jungle_slab",
         new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.JUNGLE_WOOD_ALLSIDE).sounds(BlockSoundGroup.WOOD)));

public static final Block JUNGLE_WOOD_SLAB_S = registerBlock("jungle_slab_s",
         new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.JUNGLE_WOOD_ALLSIDE_S).sounds(BlockSoundGroup.WOOD)));
...
public static final Block CHERRY_WOOD_SLAB = registerBlock("cherry_slab",
        new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.CHERRY_WOOD_ALLSIDE).sounds(BlockSoundGroup.WOOD)));

public static final Block CHERRY_WOOD_SLAB_S = registerBlock("cherry_slab_s",
        new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.CHERRY_WOOD_ALLSIDE_S).sounds(BlockSoundGroup.WOOD)));
...
public static final Block DARK_OAK_WOOD_SLAB = registerBlock("dark_oak_slab",
        new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.DARK_OAK_WOOD_ALLSIDE).sounds(BlockSoundGroup.WOOD)));

public static final Block DARK_OAK_WOOD_SLAB_S = registerBlock("dark_oak_slab_s",
        new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.DARK_OAK_WOOD_ALLSIDE_S).sounds(BlockSoundGroup.WOOD)));
...
public static final Block OAK_WOOD_SLAB = registerBlock("oak_slab",
        new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.OAK_WOOD_ALLSIDE).sounds(BlockSoundGroup.WOOD)));
...
public static final Block BIRCH_WOOD_SLAB = registerBlock("birch_slab",
        new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.BIRCH_WOOD_ALLSIDE).sounds(BlockSoundGroup.WOOD)));
...
public static final Block DIRT_SLAB = registerBlock("dirt_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.GRASS_BLOCK).sounds(BlockSoundGroup.GRAVEL)));

public static final Block CALCITE_SLAB = registerBlock("calcite_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.CALCITE).sounds(BlockSoundGroup.CALCITE)));
...
public static final Block GOLD_SLAB = registerBlock("gold_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.GOLD_BLOCK).sounds(BlockSoundGroup.METAL)));

public static final Block IRON_SLAB = registerBlock("iron_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).sounds(BlockSoundGroup.METAL)));
...
public static final Block DEAD_BUBBLE_CORAL_SLAB = registerBlock("dead_bubble_coral_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_BUBBLE_CORAL_BLOCK).sounds(BlockSoundGroup.CORAL)));
...
public static final Block SOUL_SAND_SLAB = registerBlock("soul_sand_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.SOUL_SAND).sounds(BlockSoundGroup.SOUL_SAND)));

public static final Block SOUL_SOIL_SLAB = registerBlock("soul_soil_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.SOUL_SOIL).sounds(BlockSoundGroup.SOUL_SOIL)));
...
public static final Block COPPER_SLAB = registerBlock("copper_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.COPPER_BLOCK).sounds(BlockSoundGroup.COPPER)));

public static final Block OXIDIZED_COPPER_STAIRS = registerBlock("oxidized_copper_stairs",
        new StairsBlock(Blocks.OXIDIZED_COPPER.getDefaultState(),FabricBlockSettings.copyOf(Blocks.COPPER_BLOCK)));

public static final Block OXIDIZED_COPPER_SLAB = registerBlock("oxidized_copper_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.OXIDIZED_COPPER).sounds(BlockSoundGroup.COPPER)));

public static final Block WEATHERED_COPPER_STAIRS = registerBlock("weathered_copper_stairs",
        new StairsBlock(Blocks.WEATHERED_COPPER.getDefaultState(),FabricBlockSettings.copyOf(Blocks.COPPER_BLOCK)));

public static final Block WEATHERED_COPPER_SLAB = registerBlock("weathered_copper_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.WEATHERED_COPPER).sounds(BlockSoundGroup.COPPER)));

public static final Block EXPOSED_COPPER_STAIRS = registerBlock("exposed_copper_stairs",
        new StairsBlock(Blocks.EXPOSED_COPPER.getDefaultState(),FabricBlockSettings.copyOf(Blocks.COPPER_BLOCK)));

public static final Block EXPOSED_COPPER_SLAB = registerBlock("exposed_copper_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.EXPOSED_COPPER).sounds(BlockSoundGroup.COPPER)));
...
public static final Block DEAD_HORN_CORAL_SLAB = registerBlock("dead_horn_coral_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_HORN_CORAL_BLOCK).sounds(BlockSoundGroup.CORAL)));

public static final Block DEAD_TUBE_CORAL_SLAB = registerBlock("dead_tube_coral_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_TUBE_CORAL_BLOCK).sounds(BlockSoundGroup.CORAL)));

public static final Block DEAD_BRAIN_CORAL_SLAB = registerBlock("dead_brain_coral_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_BRAIN_CORAL_BLOCK).sounds(BlockSoundGroup.CORAL)));
...
public static final Block COARSE_DIRT_SLAB = registerBlock("coarse_dirt_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.COARSE_DIRT).sounds(BlockSoundGroup.GRAVEL)));

public static final Block OBSIDIAN_SLAB = registerBlock("obsidian_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.OBSIDIAN).sounds(BlockSoundGroup.STONE)));

public static final Block ROOTED_DIRT_SLAB = registerBlock("rooted_dirt_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.ROOTED_DIRT).sounds(BlockSoundGroup.ROOTED_DIRT)));

public static final Block SAND_SLAB = registerBlock("sand_slab",
        new SlabBlock(FabricBlockSettings.copyOf(Blocks.SAND).sounds(BlockSoundGroup.SAND)));

public static final Block RED_SAND_SLAB = registerBlock("red_sand_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.RED_SAND).sounds(BlockSoundGroup.SAND)));

public static final Block SAND_STAIR = registerBlock("sand_stairs",
            new StairsBlock(Blocks.SAND.getDefaultState(),FabricBlockSettings.copyOf(Blocks.SAND)));

public static final Block RED_SAND_STAIR = registerBlock("red_sand_stairs",
            new StairsBlock(Blocks.RED_SAND.getDefaultState(),FabricBlockSettings.copyOf(Blocks.SAND)));

public static final Block WHITE_WOOL_SLAB = registerBlock("white_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.WHITE_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block BLACK_WOOL_SLAB = registerBlock("black_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.BLACK_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block CYAN_WOOL_SLAB = registerBlock("cyan_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.CYAN_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block RED_WOOL_SLAB = registerBlock("red_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.RED_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block YELLOW_WOOL_SLAB = registerBlock("yellow_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.YELLOW_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block BLUE_WOOL_SLAB = registerBlock("blue_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.BLUE_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block LIGHT_BLUE_WOOL_SLAB = registerBlock("light_blue_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.LIGHT_BLUE_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block GREEN_WOOL_SLAB = registerBlock("green_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.GREEN_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block PINK_WOOL_SLAB = registerBlock("pink_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.PINK_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block GRAY_WOOL_SLAB = registerBlock("gray_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.GRAY_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block ORANGE_WOOL_SLAB = registerBlock("orange_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.ORANGE_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block LIME_WOOL_SLAB = registerBlock("lime_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.LIME_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block PURPLE_WOOL_SLAB = registerBlock("purple_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.PURPLE_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block LIGHT_GRAY_WOOL_SLAB = registerBlock("light_gray_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.LIGHT_GRAY_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block BROWN_WOOL_SLAB = registerBlock("brown_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.BROWN_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block MAGENTA_WOOL_SLAB = registerBlock("magenta_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.MAGENTA_WOOL).sounds(BlockSoundGroup.WOOL)));

public static final Block MOSS_SLAB = registerBlock("moss_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.MOSS_BLOCK).sounds(BlockSoundGroup.MOSS_BLOCK)));

public static final Block GRAVEL_SLAB = registerBlock("gravel_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.GRAVEL).sounds(BlockSoundGroup.GRAVEL)));

public static final Block SMOOTH_BASALT_SLAB = registerBlock("smooth_basalt_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.SMOOTH_BASALT).sounds(BlockSoundGroup.BASALT)));
...
public static final Block PACKED_ICE_SLAB = registerBlock("packed_ice_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.PACKED_ICE).sounds(BlockSoundGroup.GLASS).slipperiness(1)));
...
public static final Block GRASS_SLAB = registerBlock("overgrown_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.OVERGROWN_GRASS).sounds(BlockSoundGroup.GRASS)));
...
public static final Block WEATHERED_PLANK_STAIRS = registerBlock("bog_stairs",
            new StairsBlock(ModBlocks.WEATHERED_PLANKS.getDefaultState(), FabricBlockSettings.copyOf(Blocks.OAK_PLANKS)));

public static final Block WEATHERED_PLANK_SLABS = registerBlock("bog_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.WEATHERED_PLANKS).sounds(BlockSoundGroup.WOOD)));
...
public static final Block OLD_SAPLING = registerBlock("old_sapling",
            new SaplingBlock(new OldSaplingGenerator(), FabricBlockSettings.copyOf(Blocks.OAK_SAPLING)));
...
public static final Block OLD_WOOD_SLAB = registerBlock("old_wood_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.OLD_WOOD_ALLSIDE).sounds(BlockSoundGroup.WOOD)));

public static final Block OLD_WOOD_SLAB_S = registerBlock("stripped_old_wood_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.OLD_WOOD_ALLSIDE_S).sounds(BlockSoundGroup.WOOD)));
...
public static final Block OLD_FENCE = registerBlock("old_fence",
            new FenceBlock(FabricBlockSettings.copyOf(ModBlocks.OLD_PLANKS)));

public static final Block OLD_FENCE_GATE = registerBlock("old_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(ModBlocks.OLD_PLANKS), WoodType.ACACIA));

public static final Block OLD_DOOR = registerBlock("old_door",
            new DoorBlock(FabricBlockSettings.copyOf(ModBlocks.OLD_PLANKS).nonOpaque(), BlockSetType.CHERRY));
...
public static final Block OLD_STAIRS =registerBlock("old_stairs",
            new StairsBlock(ModBlocks.OLD_PLANKS.getDefaultState(), FabricBlockSettings.copyOf(Blocks.OAK_PLANKS)));

public static final Block OLD_SLAB = registerBlock("old_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.OLD_PLANKS).sounds(BlockSoundGroup.WOOD)));
...
public static final Block SPIRAL_WOOD_SLAB = registerBlock("spiral_wood_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.SPIRAL_WOOD_ALLSIDE).sounds(BlockSoundGroup.WOOD)));

public static final Block SPIRAL_WOOD_SLAB_S = registerBlock("stripped_spiral_wood_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.SPIRAL_WOOD_ALLSIDE_S).sounds(BlockSoundGroup.WOOD)));
...
public static final Block SPIRAL_FENCE = registerBlock("spiral_fence",
            new FenceBlock(FabricBlockSettings.copyOf(ModBlocks.SPIRAL_PLANKS)));

public static final Block SPIRAL_FENCE_GATE = registerBlock("spiral_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(ModBlocks.SPIRAL_PLANKS), WoodType.ACACIA));
...
public static final Block SPIRAL_STAIRS =registerBlock("spiral_stairs",
            new StairsBlock(ModBlocks.SPIRAL_PLANKS.getDefaultState(), FabricBlockSettings.copyOf(Blocks.OAK_PLANKS)));

public static final Block SPIRAL_SLAB = registerBlock("spiral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.SPIRAL_PLANKS).sounds(BlockSoundGroup.WOOD)));
...
public static final Block DARK_SPIRAL_WOOD_SLAB = registerBlock("dark_spiral_wood_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.DARK_SPIRAL_WOOD_ALLSIDE).sounds(BlockSoundGroup.WOOD)));

public static final Block DARK_SPIRAL_WOOD_SLAB_S = registerBlock("stripped_dark_spiral_wood_slab",
            new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.DARK_SPIRAL_WOOD_ALLSIDE_S).sounds(BlockSoundGroup.WOOD)));
...
public static final Block DARK_SPIRAL_FENCE = registerBlock("dark_spiral_fence",
        new FenceBlock(FabricBlockSettings.copyOf(ModBlocks.DARK_SPIRAL_PLANKS)));
...
public static final Block DARK_SPIRAL_STAIRS =registerBlock("dark_spiral_stairs",
        new StairsBlock(ModBlocks.DARK_SPIRAL_PLANKS.getDefaultState(), FabricBlockSettings.copyOf(Blocks.OAK_PLANKS)));

public static final Block DARK_SPIRAL_SLAB = registerBlock("dark_spiral_slab",
        new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.DARK_SPIRAL_PLANKS).sounds(BlockSoundGroup.WOOD)));
...
public static final Block ANCIENT_WOOD_SLAB = registerBlock("ancient_wood_slab",
         new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.ANCIENT_WOOD_ALLSIDE).sounds(BlockSoundGroup.WOOD)));

public static final Block ANCIENT_WOOD_SLAB_S = registerBlock("stripped_ancient_wood_slab",
         new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.ANCIENT_WOOD_ALLSIDE_S).sounds(BlockSoundGroup.WOOD)));
...
public static final Block ANCIENT_FENCE = registerBlock("ancient_fence",
         new FenceBlock(FabricBlockSettings.copyOf(ModBlocks.ANCIENT_PLANKS)));
...
public static final Block ANCIENT_STAIRS =registerBlock("ancient_stairs",
         new StairsBlock(ModBlocks.ANCIENT_PLANKS.getDefaultState(), FabricBlockSettings.copyOf(Blocks.OAK_PLANKS)));

public static final Block ANCIENT_SLAB = registerBlock("ancient_slab",
         new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.ANCIENT_PLANKS).sounds(BlockSoundGroup.WOOD)));
...
public static final Block FANCY_SLAB = registerBlock("fancy_slab",
         new SlabBlock(FabricBlockSettings.copyOf(ModBlocks.FANCY_PLANK)));

public static final Block FANCY_STAIRS = registerBlock("fancy_stair",
         new StairsBlock(ModBlocks.FANCY_PLANK.getDefaultState(),FabricBlockSettings.copyOf(Blocks.OAK_PLANKS)));

public static final Block FANCY_FENCE = registerBlock("fancy_fence",
         new FenceBlock(FabricBlockSettings.copyOf(ModBlocks.FANCY_PLANK)));
...
public static final Block FANCY_WALL = registerBlock("fancy_wall",
         new WallBlock(FabricBlockSettings.copyOf(ModBlocks.FANCY_PLANK)));
...
public static final Block POTTED_OLD_ROSE = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "potted_old_rose"),
        new FlowerPotBlock(OLD_ROSE, FabricBlockSettings.copyOf(Blocks.POTTED_ALLIUM).nonOpaque()));
...
public static final Block POTTED_TINY_LILLY = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "potted_tiny_lilly"),
        new FlowerPotBlock(TINY_LILLY, FabricBlockSettings.copyOf(Blocks.POTTED_ALLIUM).nonOpaque()));

public static final Block ASTROPHYLLIA = registerBlock("astrophyllia",
        new FlowerBlock(StatusEffects.MINING_FATIGUE, 10, FabricBlockSettings.copyOf(Blocks.ALLIUM).nonOpaque().noCollision()));

public static final Block POTTED_ASTROPHYLLIA = Registry.register(Registries.BLOCK, new Identifier(Goldy_Heart.MOD_ID, "potted_astrophyllia"),
