...
public class ModItems {
    ...
    public static final Item STRAWBERRY = registerItem("strawberry", new AliasedBlockItem(ModBlocks.STRAWBER_BUSH, new FabricItemSettings()));
    public static final Item BLUEBERRY = registerItem("blueberry", new AliasedBlockItem(ModBlocks.BLUEBER_BUSH, new FabricItemSettings()));
  ...
  //  public static final Item DOUGHTNUTJAM = registerItem("donut_jam", new Item(new FabricItemSettings().food(ModFoodComponents.DOUGHNUT)));
    ...
    public static final Item BEETJAM = registerItem("beetroot_jam", new GlobalJamItem(new FabricItemSettings().food(ModFoodComponents.GLOBALJAMS)));
    public static final Item SWEETJAM = registerItem("sweet_berry_jam", new GlobalJamItem(new FabricItemSettings().food(ModFoodComponents.GLOBALJAMS)));
    public static final Item GLOWJAM = registerItem("glow_berry_jam", new GlobalJamItem(new FabricItemSettings().food(ModFoodComponents.GLOBALJAMS)));
    public static final Item CARROTJAM = registerItem("carrot_jam", new GlobalJamItem(new FabricItemSettings().food(ModFoodComponents.GLOBALJAMS)));
    ...
    public static final Item WORMBOWL = registerItem("worm_bowl", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item DEBUG = registerItem("debug", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item PEARLSTEW = registerItem("pearl_stew", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item BUTTERCORN = registerItem("buttered_corn", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item POPCORN = registerItem("popcorn", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item GRILLEDCORN = registerItem("grilled_corn", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item BOILEDSNIFFEGG = registerItem("boiled_sniffer_egg", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item SNIFFEROMLETTE = registerItem("sniffer_omelette", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item BLAZERODNOODLES = registerItem("blazerod_noodles", new GlobalBowlsItem(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item BIGBOWL = registerItem("big_wooden_bowl", new Item(new FabricItemSettings()));
    public static final Item CHOCOSTRAWBERRY = registerItem("chocolate_strawberry", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item RHUBARB = registerItem("rhubarb", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item MUFFIN = registerItem("muffin", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item APPLEMUFFIN = registerItem("apple_muffin", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item BLUEMUFFIN = registerItem("blueberry_muffin", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item STRAWMUFFIN = registerItem("strawberry_muffin", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item MELONMUFFIN = registerItem("melon_muffin", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item GLOWMUFFIN = registerItem("glow_berry_muffin", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item CARROTMUFFIN = registerItem("carrot_muffin", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item SWEETMUFFIN = registerItem("sweet_berry_muffin", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item CHOCOMUFFIN = registerItem("chocolate_muffin", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item PUMPKINMUFFIN = registerItem("pumpkin_muffin", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item PICKELS = registerItem("pickles", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item PICKELTOMATO = registerItem("pickled_tomato", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item PICKELSTRAW = registerItem("pickled_strawberries", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item PICKELONION = registerItem("pickled_onion", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item PICKELCORN = registerItem("pickled_corn", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item PICKELCHILLI = registerItem("pickled_chili", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item PICKELCARROT = registerItem("pickled_carrots", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item PICKELBLUE = registerItem("pickled_blueberries", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
    public static final Item PICKELBELL = registerItem("pickled_bellpepper", new Item(new FabricItemSettings().food(ModFoodComponents.DEBUG)));
