...
public class ModFoodComponents {
    ...
    public static final FoodComponent TOMATOSOUP = new FoodComponent.Builder().hunger(6).saturationModifier(0.25f).build();
    ...
    public static final FoodComponent BUTTEREDBAKEDPOTATO = new FoodComponent.Builder().hunger(6).saturationModifier(0.75f).build();
    ...
    public static final FoodComponent CHILLI = new FoodComponent.Builder().hunger(4).statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 100, 2), 0.10f).saturationModifier(0.5f).build();
    ...
    public static final FoodComponent MASHEDPOTATO = new FoodComponent.Builder().hunger(9).saturationModifier(0.25f).build();
    ...
    public static final FoodComponent TOAST = new FoodComponent.Builder().hunger(1).saturationModifier(0.25f).build();
    public static final FoodComponent PARSLEY = new FoodComponent.Builder().hunger(1).saturationModifier(0f).build();
    public static final FoodComponent TOASTBACON = new FoodComponent.Builder().meat().hunger(6).saturationModifier(0.5f).build();
    public static final FoodComponent TOASTBUTTER = new FoodComponent.Builder().hunger(6).saturationModifier(0.5f).build();
    public static final FoodComponent TOASTEGG = new FoodComponent.Builder().hunger(6).saturationModifier(0.5f).build();
    public static final FoodComponent TOASTJAM = new FoodComponent.Builder().hunger(6).saturationModifier(0.5f).build();
    public static final FoodComponent CABBAGEMEATROLL = new FoodComponent.Builder().meat().hunger(7).saturationModifier(0.5f).build();
    ...
    public static final FoodComponent GLOBALPIE = new FoodComponent.Builder().hunger(7).saturationModifier(0.4f).build();
    public static final FoodComponent CROISSANT = new FoodComponent.Builder().hunger(6).saturationModifier(0.25f).build();
    ...
    public static final FoodComponent VEGGIEMAKI = new FoodComponent.Builder().hunger(6).saturationModifier(0.5f).build();
    public static final FoodComponent VEGGIESANDWICH = new FoodComponent.Builder().hunger(8).saturationModifier(0.5f).build();
    public static final FoodComponent SALAD = new FoodComponent.Builder().hunger(6).saturationModifier(0.25f).build();
    public static final FoodComponent BURGER = new FoodComponent.Builder().meat().hunger(6).saturationModifier(0.4f).build();
    public static final FoodComponent GLOBALSMOOTHIES = new FoodComponent.Builder().hunger(7).saturationModifier(0.6f).build();
    ...
    public static final FoodComponent STEAKANDPOTATO = new FoodComponent.Builder().hunger(7).saturationModifier(0.55f).meat().build();
    public static final FoodComponent PUMPKINSOUP = new FoodComponent.Builder().hunger(7).saturationModifier(0.45f).build();
    public static final FoodComponent SPRINGROLL = new FoodComponent.Builder().hunger(7).saturationModifier(0.5f).build();
    public static final FoodComponent STUFFEDMUSHROOM = new FoodComponent.Builder().meat().hunger(8).saturationModifier(0.55f).build();
    public static final FoodComponent TOAST2 = new FoodComponent.Builder().hunger(6).saturationModifier(0.5f).build();
    ...
    public static final FoodComponent EGGONBREAD = new FoodComponent.Builder().hunger(6).saturationModifier(0.4f).build();
    public static final FoodComponent FRIEDEGG = new FoodComponent.Builder().hunger(4).saturationModifier(0.4f).build();
