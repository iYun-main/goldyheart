...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        BlockStatePropertyLootCondition.Builder builder12 = BlockStatePropertyLootCondition.builder(ModBlocks.RUHBARB_CROP).properties(StatePredicate.Builder.create().exactMatch(CornCropBlock.AGE, 7));
        addDrop(ModBlocks.RUHBARB_CROP, this.cropDrops(ModBlocks.RUHBARB_CROP, ModItems.RUHBARB, ModItems.RUHBARBSEEDS,builder12));


    //    AnyOfLootCondition.Builder builder1 = BlockStatePropertyLootCondition.builder(ModBlocks.CHILLI_CROP).properties(StatePredicate.Builder.create()
        //                .exactMatch(LettuceCropBlock.AGE,7))
           //     .or(BlockStatePropertyLootCondition.builder(ModBlocks.CHILLI_CROP).properties(StatePredicate.Builder.create()
              //          .exactMatch(LettuceCropBlock.AGE,8)));
      //  addDrop(ModBlocks.CHILLI_CROP, cropDrops(ModBlocks.CHILLI_CROP, ModItems.CHILLISEEDS, ModItems.CHILLI,builder1));

      //  AnyOfLootCondition.Builder builder10 = BlockStatePropertyLootCondition.builder(ModBlocks.TOMATO_CROP).properties(StatePredicate.Builder.create()
          //              .exactMatch(LettuceCropBlock.AGE,7))
        //        .or(BlockStatePropertyLootCondition.builder(ModBlocks.TOMATO_CROP).properties(StatePredicate.Builder.create()
       //                 .exactMatch(LettuceCropBlock.AGE,8)));
      //  addDrop(ModBlocks.TOMATO_CROP, cropDrops(ModBlocks.TOMATO_CROP, ModItems.TOMATOSEEDS, ModItems.TOMATO,builder10));

     //  AnyOfLootCondition.Builder builder12 = BlockStatePropertyLootCondition.builder(ModBlocks.GRAPE_CROP).properties(StatePredicate.Builder.create()
     //                   .exactMatch(LettuceCropBlock.AGE,7))
      //          .or(BlockStatePropertyLootCondition.builder(ModBlocks.GRAPE_CROP).properties(StatePredicate.Builder.create()
        //                .exactMatch(LettuceCropBlock.AGE,8)));
       // addDrop(ModBlocks.GRAPE_CROP, cropDrops(ModBlocks.GRAPE_CROP, ModItems.GRAPESEEDS, ModItems.GRAPES,builder12));

       // AnyOfLootCondition.Builder builder6 = BlockStatePropertyLootCondition.builder(ModBlocks.CUCUMBER_CROP).properties(StatePredicate.Builder.create()
     ...
     //   addDrop(ModBlocks.CUCUMBER_CROP, cropDrops(ModBlocks.CUCUMBER_CROP, ModItems.CUCUMBERSEEDS, ModItems.CUCUMBER,builder6));

     //   AnyOfLootCondition.Builder builder3 = BlockStatePropertyLootCondition.builder(ModBlocks.CORN_CROP).properties(StatePredicate.Builder.create()
       ...
       //  addDrop(ModBlocks.CORN_CROP, cropDrops(ModBlocks.CORN_CROP, ModItems.CORNSEEDS, ModItems.CORN,builder3));
    }
}
