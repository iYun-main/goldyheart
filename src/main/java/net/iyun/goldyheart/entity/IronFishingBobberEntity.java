package net.iyun.goldyheart.entity;

import it.unimi.dsi.fastutil.objects.ObjectArrayList;
import net.iyun.goldyheart.item.ModItems;
import net.iyun.goldyheart.mixin.FishingBobberAccessor;
...
public class IronFishingBobberEntity extends FishingBobberEntity {
    public IronFishingBobberEntity(EntityType<? extends FishingBobberEntity> type, World world, int luckOfTheSeaLevel, int lureLevel) {
        super(type, world, luckOfTheSeaLevel, lureLevel);
    }

    public IronFishingBobberEntity(EntityType<? extends FishingBobberEntity> entityType, World world) {
        super(entityType, world);
    }

    public IronFishingBobberEntity(PlayerEntity thrower, World world, int luckOfTheSeaLevel, int lureLevel) {
    ...
    private boolean removeIfInvalid(PlayerEntity player) {
        ...
        boolean bl = itemStack.isOf(ModItems.IRONROD);
        boolean bl2 = itemStack2.isOf(ModItems.IRONROD);
