...
public class Goldy_Heart implements ModInitializer {
	...
	public void onInitialize() {
		...
		CompostingChanceRegistry.INSTANCE.add(ModItems.BELLPEPPER,0.2f);
		CompostingChanceRegistry.INSTANCE.add(ModItems.RICE,0.1f);
		CompostingChanceRegistry.INSTANCE.add(ModItems.GARLIC,0.1f);
		CompostingChanceRegistry.INSTANCE.add(ModItems.BELLPEPPERSLICE,0.05f);
		CompostingChanceRegistry.INSTANCE.add(ModItems.BELLPEPPERSEEDS,0.05f);
		CompostingChanceRegistry.INSTANCE.add(ModItems.ONION,0.05f);
		CompostingChanceRegistry.INSTANCE.add(ModItems.ONIONSLICE,0.01f);
		CompostingChanceRegistry.INSTANCE.add(ModItems.CUTTOMATO,0.01f);
		CompostingChanceRegistry.INSTANCE.add(ModItems.CUCUMBERSLICE,0.01f);
		CompostingChanceRegistry.INSTANCE.add(ModItems.PARSLEYSEEDS,0.05f);
		CompostingChanceRegistry.INSTANCE.add(ModItems.CHILLISEEDS,0.05f);
		CompostingChanceRegistry.INSTANCE.add(ModItems.TOMATOSEEDS,0.05f);
		CompostingChanceRegistry.INSTANCE.add(ModItems.LETTUCESEEDS,0.05f);
		CompostingChanceRegistry.INSTANCE.add(ModItems.CUCUMBERSEEDS,0.05f);
		...
		CompostingChanceRegistry.INSTANCE.add(ModItems.COFFEEBEAN,0.2f);
